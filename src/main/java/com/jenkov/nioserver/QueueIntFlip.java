 ...
 *
 * <p>One additional difference is that QueueFlip has an available() method, where this is a public
 * variable in QueueFillCount.
 *
 * <p>Created by jjenkov on 18-09-2015.
 */
  ...
  public int take(int[] into, int length) {
    ...
    if (!flipped) {
      ...
      if (length <= capacity - readPos) {
        // length is lower than the elements available at the top of the elements array - copy
        // directly
